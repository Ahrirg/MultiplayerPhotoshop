...
export function TopBar({
  ...
  const [didwewon, setdidwewon] = useState<boolean>(true);

  // Track if the game has officially ended to gate screen sequences
    ...
    <div className="top">
      ...
      <WinScreen
        ...
        onGameEnd={() => {
          ...
          setEditingPicker(false);
          openVote();
          setTimeout(() => setShowLose(true), 15000);
        }}
      />
